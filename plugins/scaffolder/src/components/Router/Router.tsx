...
import { OpaqueFormField } from '../../internals';
...
export const InternalRouter = (
  ...
  // Use our CustomTemplateCard as default if no TemplateCardComponent provided
      ...
      <Route
        ...
        element={
          <TemplateListPageComponent
            TemplateCardComponent={FinalTemplateCardComponent}
